						...
						<div class="row">
							<div class="col-sm-3">
								<div class="thumb-wrapper">
									<span class="wish-icon"><i class="fa fa-heart-o"></i></span>
									<div class="img-box">
										<img src="/img/iphone.jpg" class="img-fluid" alt="iPhone">
									</div>
									<div class="thumb-content">
										<h4>Apple iPhone</h4>
...
<section style="background-color: #FFFFFF;">
	<div class="text-center container py-5" id="productos">
		<h4 class="mt-4 mb-5"><strong>Bestsellers</strong></h4>
		<div class="row">
		<?php
            if (isset($_GET["id_producto"])) {
                $obj = new productos($_GET["id_producto"], "", "", "", "");
                $resultado = $obj->Buscar_articulos();
                $h1 = 1;
                $n = 5;
            } else {
                $resultado = productos::Mostrar_articulos();
                $h1 = 2;
            }
            ?>
            <?php foreach ($resultado as $producto) {
                if ($h1 == 1) {
                    if (count($resultado) == $n) {
						...
						&nbsp;
                            <div class="card" style="width: 18rem;">
                                <img src="/img/producto<?php echo $resultado["id_producto"] ?>.png" class="card-img-top" alt="...">
                                <div class="card-body">
                                    <h4><?php echo $resultado["descripcion"] ?></h4>
									&nbsp;
                                    <p>
                                    <h3><?php echo $resultado["precio_venta"] ?>$</h3>
                                    </p>
                                    <hr>
                                    <p><?php echo $resultado["cantidad_en_existencia"] ?></p>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
                        <div class="card" style="width: 18rem;">
                            <img src="/img/producto<?php echo $producto["id_producto"] ?>.png" class="card-img-top" alt="...">
                            <div class="card-body">
                                <h3><?php echo $producto["descripcion"] ?></h3>
                                <p>
                                <h3><?php echo $producto["precio_venta"] ?></h3>
                                </p>
                                <hr>
                                <p><?php echo $producto["cantidad_en_existencia"] ?></p>
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    <div class="col text-center">
                                        <form method="post">
										<a href="#" class="btn btn-success">Comprar</a>
